...
import { Home, LayoutDashboard, Wallet, Bell, Swords, LogIn } from 'lucide-react';
...
export default function App() {
  ...
  // Initialize database / load settings on mount
  useEffect(() => {
    initDB();
  }, [initDB]);
  ...
  const navItems = isAuthenticated ? [
    ...
    { id: 'notifications', icon: Bell, label: 'Notifs', badge: unreadNotifs },
  ] : [
    { id: 'home', icon: Home, label: 'Accueil' },
          ...
          <div className="glass-dark border-t border-white/10 px-2 py-2">
            <div className="flex items-center justify-around">
              ...
              {isAuthenticated && currentUser && (
                <button
                  onClick={() => { if (confirm(`Déconnexion de ${currentUser.firstName}?`)) logout(); }}
